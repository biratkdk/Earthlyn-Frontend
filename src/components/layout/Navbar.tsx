          ...
          <div className="flex items-center gap-6">
            {user ? (
              <>
                ...
                <Link href="/rewards" className="text-gray-700 hover:text-green-600">
                  Rewards
                </Link>
                {user.role === "seller" && (
                  <Link href="/dashboard/seller/tiers" className="text-gray-700 hover:text-green-600">
                    Tiers
                  </Link>
                )}
                {user.role === "admin" && (
                  <Link href="/dashboard/admin" className="text-gray-700 hover:text-green-600">
                    Admin
                  </Link>
                )}
